"""A reproducible, genuinely from-down Acrobot swing-up task.
...
observations while changing only the task definition:

* episodes start close to the fully hanging pose;
* reward combines global target progress with the precise stock target reward;
